...
print(
    "This utility will create a new PostgreSQL database populated with baseball data.\n"
)
...
url = "https://github.com/chadwickbureau/baseballdatabank/archive/refs/tags/%s.zip" % (
    VERSION
)
